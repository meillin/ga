...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Green Analysts - Data driven and predictive CRM</title>
    ...
    <!--FACEBOOK-->
    <meta property="og:title" content="Putting all your big data to good use" >
    ...
    <meta property="twitter:title" content="Putting all your big data to good use" >
